...
const schema = z.object({
  Name: z
    .string()
    .min(3, { message: "errorCourtCategory.NameMin" })
    .max(20, { message: "errorCourtCategory.NameMax" }),
  Description: z
    .string()
    .min(20, { message: "errorCourtCategory.DescriptionMin" })
    .max(100, { message: "errorCourtCategory.DescriptionMax" }),
});
const CreateCourtCategory = ({ buttonShape }: { buttonShape: any }) => {
