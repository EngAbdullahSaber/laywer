...
const schema = z.object({
  Name: z
    .string()
    .min(3, { message: "errorStaffCategory.NameMin" })
    .max(20, { message: "errorStaffCategory.NameMax" }),
  Description: z
    .string()
    .min(20, { message: "errorStaffCategory.DescriptionMin" })
    .max(100, { message: "errorStaffCategory.DescriptionMax" }),
});
