...
export async function getCategoryPanigation(page:any,category:any ,lang:any) {
    let res = await api.get(`court/categories?page=${page}&category_type=${category}`, {
        headers: {
            'Accept-Language': lang
        }
    });
...
export async function UpdateCategory(data:any ,id:any,lang:any ) {
    let res = await api.put(`court/categories/${id}` ,data, {
        headers: {
            'Accept-Language': lang
        }
    });
...
export async function SearchCategory(id:any,category:any ,lang:any) {
    let res = await api.get(`court/categories?category_type=${category}&search=${id}` , {
        headers: {
            'Accept-Language': lang
        }
    });
